...
import com.example.mstudent.adapters.SecondaryExamsAdapter;
...
public class SecondarySchoolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secondaryExamList = new ArrayList<>();
        setupToolbar();
    ...
    private void getResults() {
        ...
        call.enqueue(new Callback<StudentDetails>() {
            ...
            public void onResponse(Call<StudentDetails> call, Response<StudentDetails> response) {
                secondaryExamList = response.body().getSecondaryExams();
                SecondaryExamsAdapter secondaryExamsAdapter = new SecondaryExamsAdapter(getApplicationContext(), secondaryExamList);
                recyclerView.setAdapter(secondaryExamsAdapter);
            ...
            public void onFailure(Call<StudentDetails> call, Throwable t) {
                Toast.makeText(SecondarySchoolActivity.this, "an error occurred", Toast.LENGTH_SHORT).show();
